...
## permApprox 1.0.2 <img src="man/figures/logo.png" align="right" height="180" />

### ✨ New features

- Add option to disable discreteness screening in GPD and Gamma
  approximation.
- `perm_approx()` now exports the tuning parameter used for the epsilon
  rule.

### 🚀️ Improvements

- Update `print()` and `summary()` methods for `perm_approx` results.
- Make `limma` an optional dependency to make package installation
  easier.
